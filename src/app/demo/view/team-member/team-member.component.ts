        ...
        if (this.team.projectId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.team.cliendId = this.selectedClientId;
                    ...
                    this.service
                        ...
                        .subscribe(
                            ...
                            (error) => {
                                alert(
                                    "something went wrong while updating new Team Member...!!"
                                );
                            }
                        );
            ...
            this.service.addTeam(this.team).subscribe(
                ...
                (error) => {
                    alert(
                        "something went wrong while creating new Team Member ...!!"
                    );
                }
            );
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                this.service.deleteTeamMember(id).subscribe(
                    ...
                    (error) => {
                        alert(
                            "Something went wrong while deleting existing team member...!!"
                        );
                    }
                );
            } else if (result.isDenied) {
